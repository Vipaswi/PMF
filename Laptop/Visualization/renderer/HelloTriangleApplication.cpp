   ...
   void initVulkan() {
    ...
    void createDescriptorSets() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            // To update config., the following struct must be filled:
            ...
            descriptorWrite.descriptorCount = 1; // Descriptors to update

            // For the descriptor types (buffers, images, and buffer views)
